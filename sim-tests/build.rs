...
fn input_masking<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn widest_input<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn add_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn sub_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn mul_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn mul_signed_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn shl_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn shr_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn shr_arithmetic_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn bit_and_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn bit_or_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn bit_xor_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn not_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn reg_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn simple_reg_delay<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn bit_test_module_0<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn bit_test_module_1<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn bits_test_module_0<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn bits_test_module_1<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn repeat_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn concat_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn eq_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn ne_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn lt_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn le_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn gt_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn ge_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn lt_signed_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn le_signed_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn gt_signed_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn ge_signed_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn mux_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn reg_next_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn instantiation_test_module_comb<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn instantiation_test_module_reg<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn nested_instantiation_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn mem_test_module_0<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn mem_test_module_1<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn mem_test_module_2<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn trace_test_module_0<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn trace_test_module_1<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn trace_test_module_2<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn trace_test_module_3<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
...
fn deep_graph_test_module<'a, P: ModuleParent<'a>>(p: &'a P) -> &Module<'a> {
    let m = p.module("deep_graph_test_module", "DeepGraphTestModule");

    // TODO: Does this suck?
    let mut x: &'a Signal<'a> = m.input("i", 1).into();
